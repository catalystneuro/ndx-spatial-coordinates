...
# -*- coding: utf-8 -*-
#
# ndx-spatial-coordinates documentation build configuration file, created by
# sphinx-quickstart on Mon Nov 16 18:48:42 2020.
#
...
project = 'ndx-spatial-coordinates'
copyright = '2020, Ben Dichter'
author = 'Ben Dichter'
...
htmlhelp_basename = 'ndx-spatial-coordinatesdoc'
...
latex_documents = [
    (master_doc, 'ndx-spatial-coordinates.tex', 'ndx-spatial-coordinates Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-spatial-coordinates', 'ndx-spatial-coordinates Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-spatial-coordinates', 'ndx-spatial-coordinates Documentation',
     author, 'ndx-spatial-coordinates', 'One line description of project.',
     'Miscellaneous'),
]
