# Next Steps for ndx-spatial-coordinates Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-spatial-coordinates directory.
...
`spec/ndx-spatial-coordinates.namespace.yaml` and
`spec/ndx-spatial-coordinates.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-spatial-coordinates
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/bendichter/ndx-spatial-coordinates/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on [PyPI](https://pypi.org/).
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-spatial-coordinates/0.1.0
...
`staged-extensions/ndx-spatial-coordinates`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-spatial-coordinates
    ```

13. Edit `staged-extensions/ndx-spatial-coordinates/ndx-meta.yaml`
...
version: 0.1.0
src: https://github.com/bendichter/ndx-spatial-coordinates
pip: https://pypi.org/project/ndx-spatial-coordinates/
license: BSD 3-Clause
maintainers:
  - bendichter
```

14. Edit `staged-extensions/ndx-spatial-coordinates/README.md`
to add information about your extension. You may copy it from
`ndx-spatial-coordinates/README.md`.

  ```bash
cp ndx-spatial-coordinates/README.md staged-extensions/ndx-spatial-coordinates/README.md
```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-spatial-coordinates
git commit -m "Add new catalog entry for ndx-spatial-coordinates" .
git push
```
...
ndx-spatial-coordinates-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-spatial-coordinates GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-spatial-coordinates-feedstock repository on GitHub.
